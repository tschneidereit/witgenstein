...
pub struct ParsedModule {
    ...
    /// The arena allocator for this module's AST.
    pub allocator: Allocator,
    /// External (non-local) import specifiers found in this module.
...
impl<'a> Visit<'a> for ImportCollector {
    fn visit_import_declaration(&mut self, decl: &ImportDeclaration<'a>) {
        ...
        } else if specifier != "ts-auto-wit" {
            // Collect imported names for external modules (skip ts-auto-wit branded types)
