...
//! Integration tests for witgenstein-ts.
//!
...
/// Run witgenstein-ts on a fixture directory, outputting to stdout (default).
...
/// Run witgenstein-ts with explicit package flag.
...
fn basic_fixture_generates_valid_wit() {
    ...
    assert!(success, "witgenstein-ts failed on basic fixture:\n{stderr}");
...
fn basic_fixture_function_signatures() {
    ...
    assert!(success, "witgenstein-ts failed");
...
fn branded_types_use_correct_wit_types() {
    ...
    assert!(
        success,
        "witgenstein-ts failed on branded fixture:\n{stderr}"
    );
...
fn resource_class_generates_resource() {
    ...
    assert!(
        success,
        "witgenstein-ts failed on resource fixture:\n{stderr}"
    );
...
fn async_result_types() {
    ...
    assert!(
        success,
        "witgenstein-ts failed on async_result fixture:\n{stderr}"
    );
...
fn explicit_package_flag_overrides() {
    ...
    assert!(success, "witgenstein-ts failed with --package:\n{stderr}");
...
fn multi_module_processes_entry() {
    ...
    assert!(
        success,
        "witgenstein-ts failed on multi_module fixture:\n{stderr}"
    );
